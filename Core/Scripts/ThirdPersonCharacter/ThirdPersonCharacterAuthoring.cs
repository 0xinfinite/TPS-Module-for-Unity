    ...
    public class Baker : Baker<ThirdPersonCharacterAuthoring>
    {
        public override void Bake(ThirdPersonCharacterAuthoring authoring)
        {
            ...
            if (vault)
            {
                ...
                {
                    vaultBuffer.Add(new VaultHand() { ValutRayStart = GetEntity(authoring.ClimbHandStart, TransformUsageFlags.Dynamic),
                ...
                {
                    vaultBuffer.Add(new VaultHand() { ValutRayStart = GetEntity(authoring.VaultHandStart, TransformUsageFlags.Dynamic),
