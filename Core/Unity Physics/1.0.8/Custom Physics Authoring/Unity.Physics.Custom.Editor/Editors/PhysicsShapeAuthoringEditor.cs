...
namespace Unity.Physics.Editor
{
    ...
    class PhysicsShapeAuthoringEditor : BaseEditor
    {
        static class Styles
        {
            ...
            public static readonly GUIContent PreventMergedOnParentLabel = EditorGUIUtility.TrTextContent(
                "Prevent Merged On Top Parent",
                " " +
                " " +
                ""
            );
...
#pragma warning disable 649
        [AutoPopulate]
        SerializedProperty m_PreventMergedOnParent;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_PreventMergedOnParent, Styles.PreventMergedOnParentLabel);
