...
namespace Unity.Physics.Authoring
{
    ...
    public sealed class PhysicsShapeAuthoring : MonoBehaviour, IInheritPhysicsMaterialProperties, ISerializationCallbackReceiver
    {
        ...
        public bool PreventMergedOnParent { get { return m_PreventMergedOnParent; } set { m_PreventMergedOnParent = value; } }//=> m_PreventMergedOnParent;
        [SerializeField]
        bool m_PreventMergedOnParent = false;
        ...
        public //internal
            void SetCapsule(CapsuleGeometryAuthoring geometry)
        {
