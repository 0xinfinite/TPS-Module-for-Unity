...
namespace Unity.Physics.Authoring
{
    class PhysicsShapeBaker : BaseColliderBaker<PhysicsShapeAuthoring>
    {
        ...
        private GameObject GetPrimaryBody(GameObject shape, out bool hasBodyComponent, out bool isStaticBody, bool preventMergeOnParent = false)
        {
            ...
            var topCollider = preventMergeOnParent ? shape : FindTopmostEnabledAncestor(shape, PhysicsShapeExtensions_NonBursted.s_CollidersBuffer);
            var topShape = preventMergeOnParent ? shape : FindTopmostEnabledAncestor(shape, PhysicsShapeExtensions_NonBursted.s_ShapesBuffer);
        ...
        ShapeComputationDataBaking GetInputDataFromAuthoringComponent(PhysicsShapeAuthoring shape, Entity colliderEntity)
        {
            ...
            var body = GetPrimaryBody(shapeGameObject, out bool hasBodyComponent, out bool isStaticBody, shape.PreventMergedOnParent);
